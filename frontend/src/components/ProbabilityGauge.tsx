...
export function ProbabilityGauge({ data }: { data: AnalyzeResponse }) {
  ...
  return (
    <div className="flex flex-col items-center rounded-card border border-border bg-surface p-7">
      ...
      <div className="relative mt-2 h-[200px] w-[340px]">
        <svg width="340" height="200" viewBox="0 0 340 200">
          ...
          <path d="M 30 170 A 140 140 0 0 1 310 170" stroke="#1A1D26" strokeWidth={22} fill="none" strokeLinecap="round" />
          <path
      ...
      <div className="mt-2 grid w-full grid-cols-2 gap-2.5">
        <div className="rounded-chip border border-bull-softer bg-elevated px-3.5 py-3">
        ...
        <div className="rounded-chip border border-bear-softer bg-elevated px-3.5 py-3">
          <div className="mb-1 flex items-center gap-1.5">
